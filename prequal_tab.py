...
PREQUAL_ITEMS = [
    ...
    },
    {
        ...
        "description": "Annual Modern Slavery Act statement (or equivalent)",
        "why": "Mandatory for suppliers over £36M revenue; recommended for all under our supply chain policy.",
    },
    {
        "id": "abc",
